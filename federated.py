...
class TeeLogger:
    ...
    This produces the thesis txt logs for dirty and clean runs.
    """
...
class DummyWriter:
    """
    TensorBoard replacement for PC03.
    Prevents event-file FileNotFoundError crashes.
    """
...
if __name__ == '__main__':
    ...
    try:
        ...
        print("TensorBoard disabled on PC03 to prevent event-file crash.")
        print(f"TensorBoard log_dir would have been: {log_dir}")
